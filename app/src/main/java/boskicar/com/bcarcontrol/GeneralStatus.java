...
{	
	...
	private String lastFBOrderDate;

	private OrderType lastFBOrderType;

	private String lastLROrderDate;
	...
	public String getLastFBOrderDate() {
		return lastFBOrderDate;
	}

	public void setLastFBOrderDate(String lastFBOrderDate) {
	...
	public String getLastLROrderDate() {
		return lastLROrderDate;
	}

	public void setLastLROrderDate(String lastLROrderDate) {
